...
namespace Inventory.EntryPoints {
    public class PlacedEntryPoint : IPlacedItem, IPlacedEntryPoint, IDisposable {
        ...
        private PlacedEntryPoint(GridEntryPoint entryPoint, Vector2Int origin) {
        ...
        public static PlacedEntryPoint Create(FlowKind kind, Vector2Int position) {
            GridEntryPoint entryPoint = GridEntryPoint.Create(kind);
            PlacedEntryPoint placedEntryPoint = new PlacedEntryPoint(entryPoint, position);

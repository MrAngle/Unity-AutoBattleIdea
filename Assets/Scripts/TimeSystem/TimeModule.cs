...
namespace TimeSystem
{
    ...
    public static class TimeModule
    {
        ...
        public static Task ContinueIn(float seconds, CancellationToken ct = default) => Get(DEFAULT).ContinueIn(seconds, ct);
        public static CoroutineHandle Schedule(float seconds, Action callback, CancellationToken ct = default) => Get(DEFAULT).Schedule(seconds, callback, ct);
